...
@section('css')
    <link rel="stylesheet" href="{{ config('streams.assets_path') }}/css/media/media.css"/>
    <link rel="stylesheet" type="text/css" href="{{ config('streams.assets_path') }}/js/select2/select2.min.css">
    <link rel="stylesheet" href="{{ config('streams.assets_path') }}/css/media/dropzone.css"/>
@stop
...
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="admin-section-title">
                    <h3><i class="streams-images"></i> Media</h3>
                </div>
                <div class="clear"></div>
                ...
                <div id="filemanager">
                    ...
                    <div id="toolbar">
                        <div class="btn-group offset-right">
                            <button type="button" class="btn btn-primary" id="upload"><i class="streams-upload"></i>
                                Upload
                            </button>
                            <button type="button" class="btn btn-primary" id="new_folder"
                                    onclick="jQuery('#new_folder_modal').modal('show');"><i class="streams-folder"></i>
                                Add folder
                            </button>
                        </div>
                        <button type="button" class="btn btn-default" id="refresh"><i class="streams-refresh"></i>
                        </button>
                        <div class="btn-group offset-right">
                            <button type="button" class="btn btn-default" id="move"><i class="streams-move"></i> Move
                            </button>
                            <button type="button" class="btn btn-default" id="rename"><i class="streams-character"></i>
                                Rename
                            </button>
                            <button type="button" class="btn btn-default" id="delete"><i class="streams-trash"></i>
                                Delete
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="content">
                        ...
                        <div class="breadcrumb-container">
                            ...
                            <div class="toggle"><span>Close</span><i class="streams-double-right"></i></div>
                        </div>
                        <div class="flex">
                            ...
                            <div id="left">
                                ...
                                <div id="no_files">
                                    <h3><i class="streams-meh"></i> No files in this folder.</h3>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><i class="streams-move"></i> Move File/Folder</h4>
                                </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal"
                                            aria-hidden="true">&times;</button>
                                    <h4 class="modal-title"><i class="streams-character"></i> Rename File/Folder</h4>
                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="streams-folder"></i> Add New Folder</h4>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="streams-warning"></i> Are You Sure</h4>
                            </div>

                            <div class="modal-body">
                                <h4>Are you sure you want to delete '<span class="confirm_delete_name"></span>'</h4>
                                <h5 class="folder_warning"><i class="streams-warning"></i> Deleting a folder will remove
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal"
                                        aria-hidden="true">&times;</button>
                                <h4 class="modal-title"><i class="streams-warning"></i> Drag and drop files or click
                                    below to upload</h4>
                            </div>
    ...
    <script src="{{ config('streams.assets_path') }}/js/select2/select2.min.js"></script>
    <script src="{{ config('streams.assets_path') }}/js/media/dropzone.js"></script>
    <script src="{{ config('streams.assets_path') }}/js/media/media.js"></script>
    <script type="text/javascript">
        var media = new StreamsMedia({
            baseUrl: "{{ route('streams.dashboard') }}"
        });
        $(function () {
            media.init();
        });
