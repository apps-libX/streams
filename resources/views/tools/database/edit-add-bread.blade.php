...
@section('page_header')
    <div class="page-title">
        <i class="streams-data"></i> @if(isset($dataType->id)){{ 'Edit BREAD for ' . $dataType->name . ' table' }}@elseif(isset($table)){{ 'Create BREAD for ' . $table . ' table' }}@endif
    </div>
@stop
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form role="form"
                      action="@if(isset($dataType->id)){{ route('streams.database.update_bread', $dataType->id) }}@else{{ route('streams.database.store_bread') }}@endif"
                      method="POST">
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <table id="users" class="table table-hover">
                            ...
                            @foreach($fieldOptions as $data)
                                @if(isset($dataType->id))
                                    <?php $dataRow = RAD\Streams\Models\DataRow::where('data_type_id', '=',
