...
@section('page_header')
    <h1 class="page-title">
        <i class="streams-data"></i> @if(isset($table)){{ 'Editing ' . $table . ' table' }}@else{{ 'New Table' }}@endif
    </h1>
@stop
...
@section('content')
    ...
    <table class="table table-bordered" style="width:100%; display:none;">
        ...
        <tr class="tablerow" style="display:none;">
            ...
            <td>
                <div class="btn btn-danger delete-row"><i class="streams-trash"></i></div>
            </td>
    ...
    <div class="page-content container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="@if(isset($table)){{ route('streams.database.update', $table) }}@else{{ route('streams.database.store') }}@endif"
                      method="POST">
