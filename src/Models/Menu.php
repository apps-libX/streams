...
class Menu extends Model
{
    ...
    {
        return $this->hasMany('RAD\Streams\Models\MenuItem');
    }
    ...
    public static function display($menuName, $type = null, $options = [])
    {
        ...
        self::$prefix = ltrim(route('streams.dashboard', [], false), '/');
    ...
    public static function buildAdminOutput($menuItems, $output, $options, $child = null)
    {
        ...
        foreach ($parentItems as $item) {
            ...
            $output .= '<div class="btn-sm btn-danger pull-right delete" data-id="'.$item->id.'"><i class="streams-trash"></i> Delete</div>';
            $output .= '<div class="btn-sm btn-primary pull-right edit" data-id="'.$item->id.'" data-title="'.$item->title.'" data-url="'.$item->url.'" data-target="'.$item->target.'" data-icon_class="'.$item->icon_class.'" data-color="'.$item->color.'"><i class="streams-edit"></i> Edit</div>';
            $output .= '</div>';
