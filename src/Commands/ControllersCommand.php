...
class ControllersCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'streams:controllers';
     ...
     * @var string
     */
    protected $description = 'Publish all the controllers from Streams.';
    ...
    {
        $stub = $this->getStub();
        $files = $this->filesystem->files(base_path('vendor/rad/streams/src/Http/Controllers'));
        $namespace = config('streams.controllers.namespace', 'RAD\\Streams\\Http\\Controllers');
        ...
        $this->info('Published Streams controllers!');
    }
    ...
    {
        return $this->filesystem->get(base_path('/vendor/rad/streams/stubs/'.$this->stub));
    }
    ...
    protected function generateContent($stub, $class)
    {
        ...
        $content = str_replace(
            'FullBaseDummyClass',
            'RAD\\Streams\\Http\\Controllers\\'.$class,
            $content
        );
