...
use RAD\Streams\Http\Controllers\Traits\DatabaseQueryBuilder;
...
class DatabaseTest extends TestCase
{
    ...
    public function test_can_create_table()
    {
        ...
        // Create table
        $this->post(route('streams.database.store'), [
            'name'     => 'streamstest',
            'field'    => [
                'id',
                'tiny_int_field',
        ...
        $this->assertRedirectedToRoute('streams.database.index', [], [
            'message'    => 'Successfully created streamstest table',
            'alert-type' => 'success',
        ]);

        // Test table exist
        $this->assertTrue(Schema::hasTable('streamstest'));

        // Test column type
        $columns = DB::select(DB::raw('PRAGMA table_info(streamstest)'));
    ...
    public function test_can_create_unique_key_column()
    {
        ...
        // Test column type
        $columns = DB::select(DB::raw('PRAGMA INDEX_LIST(streamstest)'));
    ...
    public function test_can_update_table_with_same_fields()
    {
        ...
        $this->put(route('streams.database.update', ['streamstest']), [
            'name'           => 'streamstest',
            'original_name'  => 'streamstest',
            'field'          => [
                'id',
                'title',
                'address',
        ...
        // Test redirect to correct page
        $this->assertRedirectedToRoute('streams.database.index', [], [
            'message'    => 'Successfully updated streamstest table',
            'alert-type' => 'success',
        ]);
    ...
    public function test_can_change_table_name()
    {
        ...
        // Test redirect to correct page
        $this->assertRedirectedToRoute('streams.database.index', [], [
            'message'    => 'Successfully updated streamspost table',
            'alert-type' => 'success',
        ]);

        // Test table exist
        $this->assertTrue(Schema::hasTable('streamspost'));
    }
    ...
    public function test_can_delete_table()
    {
        ...
        $this->delete(route('streams.database.destroy', ['streamstest']));

        // Test redirect to correct page
        $this->assertRedirectedToRoute('streams.database.index', [], [
            'message'    => 'Successfully deleted streamstest table',
            'alert-type' => 'success',
        ]);

        // Test table exist
        $this->assertFalse(Schema::hasTable('streamstest'));
    }
}
